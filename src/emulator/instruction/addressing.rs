...
pub const ADDRESSING_OP0_TABLE: [Addressing; 256] = [
    ...
    None,     None, AbsB, AbsB,    A,      A,      A,       A,   A,   Abs, PSW(C),  Abs, Abs16, PSW(ALL),    Abs16,    None, // 0x0X
    PSW(N),   None, AbsB, AbsB,    A,      A,      A,       A, Abs,  IndX,    Abs, AbsX,     A,        X,        X,  Abs16X, // 0x1X
    PSW(P),   None, AbsB, AbsB,    A,      A,      A,       A,   A,   Abs, PSW(C),  Abs, Abs16,        A,      Abs,     Imm, // 0x2X
    PSW(N),   None, AbsB, AbsB,    A,      A,      A,       A, Abs,  IndX,    Abs, AbsX,     A,        X,        X,   Abs16, // 0x3X
    PSW(P),   None, AbsB, AbsB,    A,      A,      A,       A,   A,   Abs, PSW(C),  Abs, Abs16,        X,    Abs16,     Imm, // 0x4X
    PSW(V),   None, AbsB, AbsB,    A,      A,      A,       A, Abs,  IndX,     YA, AbsX,     A,        X,        Y,   Abs16, // 0x5X
    PSW(C),   None, AbsB, AbsB,    A,      A,      A,       A,   A,   Abs, PSW(C),  Abs, Abs16,        Y,      Abs,    None, // 0x6X
    PSW(V),   None, AbsB, AbsB,    A,      A,      A,       A, Abs,  IndX,     YA, AbsX,     A,        A,        Y,    None, // 0x7X
    PSW(C),   None, AbsB, AbsB,    A,      A,      A,       A,   A,   Abs, PSW(C),  Abs, Abs16,        Y, PSW(ALL),     Abs, // 0x8X
    PSW(C),   None, AbsB, AbsB,    A,      A,      A,       A, Abs,  IndX,     YA, AbsX,     A,        X,       YA,       A, // 0x9X
    PSW(I),   None, AbsB, AbsB,    A,      A,      A,       A,   A,   Abs, PSW(C),  Abs, Abs16,        Y,        A, Special, // 0xAX
    PSW(C),   None, AbsB, AbsB,    A,      A,      A,       A, Abs,  IndX,     YA, AbsX,     A,       SP,        A, Special, // 0xBX
    PSW(I),   None, AbsB, AbsB,  Abs,  Abs16,   IndX, IndAbsX,   X, Abs16, Abs13B,  Abs, Abs16,        X,        X,      YA, // 0xCX
    PSW(Z),   None, AbsB, AbsB, AbsX, Abs16X, Abs16Y, IndAbsY, Abs,  AbsY,    Abs, AbsX,     Y,        A,     AbsX,       A, // 0xDX
    PSW(ALL), None, AbsB, AbsB,    A,      A,      A,       A,   A,     X, Abs13B,    Y,     Y,   PSW(C),        Y,    None, // 0xEX
    PSW(Z),   None, AbsB, AbsB,    A,      A,      A,       A,   X,     X,    Abs,    Y,     Y,        Y,        Y,    None, // 0xFX
];
...
pub const ADDRESSING_OP1_TABLE: [Addressing; 256] = [
    ...
    Imm,  None, None, Imm, AbsX, Abs16X, Abs16Y, IndAbsY, Imm,   Abs,   None, None,  None, None, Abs16, None, // 0x1X
    None, None, None, Imm,  Abs,  Abs16,   IndX, IndAbsX, Imm,   Abs, Abs13B, None,  None, None,   Imm, None, // 0x2X
    ...
    Imm,  None, None, Imm, AbsX, Abs16X, Abs16Y, IndAbsY, Imm,   Abs,    Abs, None,  None,    A, Abs16, None, // 0x5X
    None, None, None, Imm,  Abs,  Abs16,   IndX, IndAbsX, Imm,   Abs, Abs13B, None,  None, None,   Imm, None, // 0x6X
    Imm,  None, None, Imm, AbsX, Abs16X, Abs16Y, IndAbsY, Imm,   Abs,    Abs, None,  None,    X,   Abs, None, // 0x7X
    None, None, None, Imm,  Abs,  Abs16,   IndX, IndAbsX, Imm,   Abs, Abs13B, None,  None,  Imm,  None,  Imm, // 0x8X
    Imm,  None, None, Imm, AbsX, Abs16X, Abs16Y, IndAbsY, Imm,   Abs,    Abs, None,  None,   SP,     X, None, // 0x9X
    None, None, None, Imm,  Abs,  Abs16,   IndX, IndAbsX, Imm,   Abs, Abs13B, None,  None,  Imm,  None, None, // 0xAX
    Imm,  None, None, Imm, AbsX, Abs16X, Abs16Y, IndAbsY, Imm,   Abs,    Abs, None,  None,    X,  None, None, // 0xBX

pub fn asl(op0: u8, carry_flag: bool) -> (u8, u8) {
...
pub fn rol(op0: u8, carry_flag: bool) -> (u8, u8) {
    let shifter = |op, carry| -> u8 {
...
pub fn lsr(op0: u8, carry_flag: bool) -> (u8, u8) {
...
pub fn ror(op0: u8, carry_flag: bool) -> (u8, u8) {
    let shifter = |op, carry| -> u8 {
...
fn shift(op0: u8, carry_flag: bool, shifter: impl Fn(u8, bool) -> u8, is_carry: impl Fn(u8) -> bool) -> (u8, u8) {

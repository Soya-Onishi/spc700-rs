pub fn addw(op0: u16, op1: u16) -> (u16, u8) {
...
pub fn subw(op0: u16, op1: u16) -> (u16, u8) {
    addw(op0, (!op1).wrapping_add(1))
}

fn cmpw(op0: u16, op1: u16) -> (u16, u8) {
...
pub fn div(ya: u16, x: u16) -> (u16, u8) {
    fn is_sign(a: u16) -> u8 {
        (a & 0x80) as u8
    }
    fn is_zero(a: u16) -> u8 {
        let flag = (a & 0xff) == 0 as u8;
        flag << 1
    }
    fn is_overflow(a: u16) -> u8 {
        let flag = a > 0xff as u8;
        flag << 6
    }
    fn is_half(y: u16, x: u16) -> u8 {
        let flag = (x & 0xf) <= (y & 0xf) as u8;
        flag << 3
    }
